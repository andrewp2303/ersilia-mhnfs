...
def train(cfg):
    ...
    # Load model (decide whether to use checkpoint or not)
    model = MHNfs.load_from_checkpoint('/Users/andrew/Code/ersilia/ersilia-mhnfs/assets/mhnfs_data/mhnfs_checkpoint.ckpt')
    # model = MHNfs(cfg)
    model = model.to(cfg.system.ressources.device)
