...
from mhnfs.iclr_code_base.losses import losses

from mhnfs.iclr_code_base.modules import (
    EncoderBlock,
...
from mhnfs.iclr_code_base.metrics import (
    auc_score_train,
    deltaAUPRC_score_train,
)
from mhnfs.iclr_code_base.distance_metrics import distance_metrics
    ...
    def __init__(self, config: OmegaConf):
        ...
        self.trainExemplarMemory = (
            torch.unsqueeze(
                torch.from_numpy(
                    np.load(
                        # TODO: generalize/replace
                        "/Users/andrew/Code/ersilia/ersilia-mhnfs/data/preprocessed_datasets/training/mol_inputs.npy"
                    ).astype("float32")
                ),
                0,
